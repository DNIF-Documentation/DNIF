 ...
 **Note:** In order to receive log over the DNIF Platform, need to configure [Syslog Connector](/docs/documents/connect-extract-enrich/Connectors/SUPPORTED-CONNECTORS/syslog.md)on DNIF Console.
