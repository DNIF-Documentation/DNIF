...
### 4. **Attach Permissions to the User**
    ...
    4. Here is an example of a minimal IAM policy that covers these actions:

<!-- ![CloudWatch Connector](images-CloudWatch%20Connector/CloudWatch-Connector-1.webp) -->
...
<!-- ![CloudWatch Connector](images-CloudWatch%20Connector/CloudWatch-Connector-2.webp) -->
