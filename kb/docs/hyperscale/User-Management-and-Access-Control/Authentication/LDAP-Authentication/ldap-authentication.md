...
- On the[Manage Users](/docs/documents/User-Management-and-Access-Control/Users-and-Roles/Manage-Organization-and-users/manage-users.md) page, an icon is added next to the username indicating that the user is an LDAP connected user.
