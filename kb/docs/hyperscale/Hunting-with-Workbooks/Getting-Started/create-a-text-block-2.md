...
![image 1-Dec-05-2023-07-27-03-4461-AM](./Images/ImagesCreateaTextBlock/CreateaTextBlock1.webp)

- Click the **plus** icon on the Workbook page and select **Text Block** from the list. The following screen is displayed:

![image 2-Dec-05-2023-07-27-23-6002-AM](./Images/ImagesCreateaTextBlock/CreateaTextBlock2.webp)

- Enter the required information in the Markdown Editor

![image 3-Dec-05-2023-07-27-39-6263-AM](./Images/ImagesCreateaTextBlock/CreateaTextBlock3.webp)
