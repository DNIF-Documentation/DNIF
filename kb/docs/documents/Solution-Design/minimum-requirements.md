...
DNIF a unified security solution the system, should meet the recommended minimum requirements for an optimal experience. To [get started](/docs/documents/DNIF-AI/Getting-Started-with-DNIF-AI/getting-started-with-dnif-ai.md)
 with DNIF, one needs three nodes, each node represents a DNIF component.
