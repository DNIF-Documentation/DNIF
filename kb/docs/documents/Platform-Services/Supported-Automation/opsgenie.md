...
1. In the **[ Configurtion](/docs/documents/Platform-Services/Supported-Automation/Configuring-Automation.md) Box**, enter the **Configuration Name** to uniquely identify this configuration.
