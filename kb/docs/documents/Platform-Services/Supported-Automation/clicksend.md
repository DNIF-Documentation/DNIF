...
- In the **[Configure Automation?](/docs/documents/Platform-Services/Supported-Automation/Configuring-Automation.md)**, enter the **Configuration Name** to uniquely identify this configuration.
