...
- In the **[ Configurtion](/docs/documents/Platform-Services/Supported-Automation/Configuring-Automation.md)**, enter the **Configuration Name** to uniquely identify this configuration.

- [Create a Workbook](/docs/documents/Hunting-with-Workbooks/Getting-Started/how-to-create-a-workbook-2.md)for a Microsoft Teams channel in your account.
