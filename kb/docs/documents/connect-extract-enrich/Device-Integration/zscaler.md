...
1. Configure an [Installed Connector](/docs/documents/connect-extract-enrich/Connectors/SUPPORTED-CONNECTORS/tcp.md).

3. Use [TCP Connector](/docs/documents/connect-extract-enrich/Connectors/SUPPORTED-CONNECTORS/tcp.md)
