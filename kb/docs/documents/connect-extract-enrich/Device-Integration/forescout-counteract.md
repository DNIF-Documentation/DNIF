...
- Select **Plugins**. The Plugins pane opens.  
    ...
    ![](./images-ForescoutCounterACT/Forescout-CounterACT-1.webp)
...
- Select **Configure**. The CEF configuration pane opens  
    ...
    ![image 1-Dec-04-2023-08-55-48-3853-AM](./images-ForescoutCounterACT/Forescout-CounterACT-2.webp)
      
    

- To add a SIEM server, select **Add**. The **Add SIEM server** wizard is displayed.  
      
    ![](./images-ForescoutCounterACT/Forescout-CounterACT-3.webp)
...
- From the Assigned CounterACT devices pane, choose one of the following options:  
    ...
    ![](./images-ForescoutCounterACT/Forescout-CounterACT-4.webp)
...
- Click **Finish**. The server configuration appears in the CEF pane.  
    ...
    ![](./images-ForescoutCounterACT/Forescout-CounterACT-5.webp)
