...
1. Configure Syslog
<!-- (Internal link to be added)#configure-syslog -->

3. Configuring Syslog Format for Palo Alto Networks Devices
<!-- ((Internal link to be added)#configure_syslog_palo) -->

5. Configure TLS
<!-- (Internal link to be added)(#configure-TLS) -->

7. Validate Logs
<!-- (Internal link to be added)(#validatelogs) -->
...
(#Configure-syslog-forwarding-for-Traffic-Threat) -->

- Configure syslog forwarding for System, Config, HIP Match, and Correlation logs
<!-- (Internal link to be added)(#HIPmatchandcorrelationlogs) -->

- (Optional) Configure the header format of syslog messages

<!-- (Internal link to be added)(#Configureheaderformat) -->

- Create a certificate to secure syslog communication over TLSv1.2
<!-- (Internal link to be added)(#Certificatetosecuresyslog) -->

- Commit your changes and review the logs on the syslog server
<!-- (Internal link to be added)(#commitchangesandreviewlogs) -->

- (Optional) Configure the firewall to terminate the connection to the syslog server upon FQDN refresh

<!-- (Internal link to be added)(#Configurefirewalltoterminate) -->
...
![image 1-Dec-04-2023-06-11-55-7845-AM](./images-PaloAltoDeviceIntegration/Palo-Alto-Device-Integration-1.webp)
...
![Image 2-Dec-04-2023-06-12-13-3030-AM](./images-PaloAltoDeviceIntegration/Palo-Alto-Device-Integration-2.webp)
