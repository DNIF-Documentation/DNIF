...
![image 1-Apr-10-2024-05-41-10-5756-AM](./images-HTTPConnector/HTTP-Connector-1.webp)
...
![image 2-Apr-10-2024-05-44-02-0957-AM](./images-HTTPConnector/HTTP-Connector-2.webp)
...
![Authentication](./images-HTTPConnector/HTTP-Connector-3.webp)
...
5. **Headers:** The header's value would differ depending on the current authentication mode. Please refer to the Authentication Section above for the header value. The common header would be "Content-Type": "application/json"  
    ...
    ![image 2-Apr-26-2024-09-29-41-5402-AM](./images-HTTPConnector/HTTP-Connector-4.webp)  
...
7. **Payload:**  
    ...
    ![image 3-Apr-26-2024-09-32-03-9109-AM](./images-HTTPConnector/HTTP-Connector-5.webp)  
...
![image 4-Apr-26-2024-09-36-46-2703-AM](./images-HTTPConnector/HTTP-Connector-6.webp)
...
5. **Headers:** The header's value would differ depending on the current authentication mode. Please refer to the Authentication Section above for the header value.  
    ...
    ![image 2-Apr-26-2024-09-29-41-5402-AM](./images-HTTPConnector/HTTP-Connector-7.webp)  
...
![image 5-Apr-26-2024-09-45-43-7471-AM](./images-HTTPConnector/HTTP-Connector-8.webp)

5\. Sample:  
  

![image 6-Apr-26-2024-09-49-15-3360-AM](./images-HTTPConnector/HTTP-Connector-9.webp)

## **Configurations**

- Using the HTTP Connector, follow the configuration requirements to forward logs to DNIF.

![image 7-Apr-26-2024-09-54-58-5289-AM](./images-HTTPConnector/HTTP-Connector-10.webp)
...
![image 8-Apr-26-2024-09-59-49-9428-AM](./images-HTTPConnector/HTTP-Connector-11.webp)
...
![image 9-Apr-26-2024-10-04-21-2671-AM](./images-HTTPConnector/HTTP-Connector-12.webp)
...
![image 10-3](./images-HTTPConnector/HTTP-Connector-13.webp)
...
![image 11-3](./images-HTTPConnector/HTTP-Connector-14.webp)
