...
- Create a new App  
    ...
    ![](./images-ShopifyConnector/Shopify-Connector-1.webp)  
...
- Now on the app overview screen, Click **Configure Admin API scopes**.  
    ...
    ![](./images-ShopifyConnector/Shopify-Connector-2.webp)  
...
- Select the read permissions of all the necessary scopes to get your audit events for products, orders, customers, inventory, etc. Click **Save**.  
    ...
    ![](./images-ShopifyConnector/Shopify-Connector-3.webp)  
...
![](./images-ShopifyConnector/Shopify-Connector-5.png)
