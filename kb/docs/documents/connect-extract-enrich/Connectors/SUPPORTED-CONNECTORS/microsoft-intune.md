...
![image 1-2](./images-MicrosoftIntune/Microsoft-Intune-1.webp)

4\. Create new registration

![image 2-2](./images-MicrosoftIntune/Microsoft-Intune-2.webp)

5\. Enter name, select appropriate account type and click Register

![image 3-1](./images-MicrosoftIntune/Microsoft-Intune-3.webp)

6\. Click API permissions

![image 4-1](./images-MicrosoftIntune/Microsoft-Intune-4.webp)

7\. Click +Add a permission

![image 5-1](./images-MicrosoftIntune/Microsoft-Intune-5.webp)

8\. Select Microsoft Graph

![image 6-1](./images-MicrosoftIntune/Microsoft-Intune-6.webp)

9\. In the **Application Permissions** and **Delegated Permissions**:-

![image 7-1](./images-MicrosoftIntune/Microsoft-Intune-7.webp)
...
![image 8-1](./images-MicrosoftIntune/Microsoft-Intune-8.webp)

10\. Click Certificates & secrets in the menu on the left and Click +New client secret

![image 9-1](./images-MicrosoftIntune/Microsoft-Intune-9.webp)

11\. Enter description and Click Add

![image 10](./images-MicrosoftIntune/Microsoft-Intune-10.webp)

12\. Copy your newly created secret and Make a note of it

![image 11](./images-MicrosoftIntune/Microsoft-Intune-11.webp)

13\. Click Overview in the menu on the left

![image 13](./images-MicrosoftIntune/Microsoft-Intune-12.webp)
...
![image 14](./images-MicrosoftIntune/Microsoft-Intune-13.webp)
