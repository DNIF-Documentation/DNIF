...
- In the navigation pane, choose Users and then choose Add user.  
    ...
    ![image 1-Nov-16-2023-10-22-54-6987-AM](./images-AWSKinesis/AWS-Kinesis-1.webp)  
...
![image 2-Nov-16-2023-10-23-14-4133-AM](./images-AWSKinesis/AWS-Kinesis-2.webp)
...
- On the Set permissions page, specify how you want to assign permissions to this set of new users. Choose **Attach existing policies directly &gt; Create Policy**  
    ...
    ![image 3-Nov-16-2023-10-24-04-8310-AM](./images-AWSKinesis/AWS-Kinesis-3.webp)  
...
- Click Next: Tags button  
    ...
    ![image 4-Nov-16-2023-10-26-22-6713-AM](./images-AWSKinesis/AWS-Kinesis-4.webp)  
      
    

- Add user tags for identification purposes and click on Next:Review button.

![image 5-Nov-16-2023-10-26-51-4616-AM](./images-AWSKinesis/AWS-Kinesis-5.webp)

- Review all the configurations and click Create user button.  
    

![image 6-4](./images-AWSKinesis/AWS-Kinesis-6.webp)
...
![image 7-3](./images-AWSKinesis/AWS-Kinesis-7.webp)
