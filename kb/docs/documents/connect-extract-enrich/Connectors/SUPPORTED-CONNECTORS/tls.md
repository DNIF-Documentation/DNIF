...
Once the connector is configured, validate if the connector is listed under  [**Collection Status**][Collection Status](/docs/documents/Operations/Collection-Status/collection-status.md)
