...
![](./IMAGES-TrendMicroAuditLogs/Trend-Micro-Audit-Logs-1.webp)

- Once logged in, go to settings icon on the left navigation bar and click User Accounts.  
      
      
    ![](./IMAGES-TrendMicroAuditLogs/Trend-Micro-Audit-Logs-2.webp)  
...
- On this window make the following changes and click Save.
    ...
    - Generate a new authentication token.  
        ...
        ![](./IMAGES-TrendMicroAuditLogs/Trend-Micro-Audit-Logs-3.webp)  
...
![](./IMAGES-TrendMicroAuditLogs/Trend-Micro-Audit-Logs-4.webp)
...
Once the connector is configured, validate if the connector is listed under the  [**Collection Status**](/docs/documents/Operations/Collection-Status/collection-status.md)  screen with status as **Active**. This signifies the connector is configured successfully and data is ready to ingest.
