...
![image 1-Apr-12-2024-06-55-27-6473-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-1.webp)
...
![image 2-Apr-12-2024-06-58-41-0414-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-2.webp)
...
![image 3-Apr-12-2024-07-01-06-9191-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-3.webp)

- Uncheck the Require Secret for Refresh Token Flow checkbox.  
      
    

![image 4-Apr-12-2024-07-02-47-9260-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-4.webp)
...
- Navigate to your created connected app and click on the arrow on the right side.  
    ...
    ![image 5-Apr-12-2024-07-05-30-8020-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-5.webp)  
...
![image 6-Apr-12-2024-07-07-11-3497-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-6.webp)

- Copy the values of the consumer key and consumer secret and keep it.  
      
      
    ![image 7-Apr-12-2024-07-09-03-5200-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-7.webp)  
...
![image 8-Apr-12-2024-07-10-47-2375-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-8.webp)
...
![image 9-Apr-12-2024-07-18-05-8947-AM](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-9.webp)

- Select the existing profile as a standard user and Clone it.

- Specify a name for the profile.

![image 11-2](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-10.webp)
...
![image 12-1](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-11.webp)

- Navigate to **Administrative Permissions**, select **API Enabled** and **Manage Users** checkbox.  
      
    

![image 13-2](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-12.webp)

- Navigate to **General User Permissions**, and select **View Event Log Files** checkbox.  
      
    

![image 14-2](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-13.webp)
...
![image 14-2](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-14.webp)
...
![image 16-1](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-15.webp)
...
![image 17-1](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-16.webp)
...
![image 18-1](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-17.webp)
...
![image 19-1](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-18.webp)

- In the right panel of the page, navigate to **My Personal Information > Reset My Security Token**.  
      
    

![image 20](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-19.webp)
...
![image 21-1](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-20.webp)

## **Configurations**

- The following are the configurations to forward Salesforce Pub/Sub Connector logs to DNIF.‌  
      
    ![image 22](./images-SalesforcePubSubConnector/Salesforce-PubSub-Connector-21.webp)  
...
- If the connection is not successful an error message will be displayed.   
    Refer to [Troubleshooting Connector Validations](/docs/documents/Troubleshooting-and-Debugging/troubleshooting-connector-validations.md) for more details on the error message.
