...
11. For an external ID please enter your DNIF tenant ID (previously known as cluster id) which can be seen in the URL of any page after you log in to your DNIF Console.  
    ...
    ![image 2](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-1.webp)  
...
13. Leave the rest of the options un-selected.  
    ...
    ![image 2-1](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-2.webp)  
...
17. Create **a new policy** or attach **an existing policy** with the following permissions.  
    ...
    }![image 3](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-3.webp)  
      
      
    ![image 4](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-4.webp)  
      
      
    ![](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-5.webp)  
      
    

19. Attach this newly created policy to the role  
      
    ![image 6](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-6.webp)  
    

21. Name, review and finish creating this role.  
      
      
    ![image 7](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-7.webp)  
      
      
    

23. Name, review and finish creating this role.![image 8](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-8.webp)  
...
![image 9](./images-AWSS3OptimizedCrossAccountConnector/AWS-S3-Optimized-Cross-Account-Connector-9.webp)
