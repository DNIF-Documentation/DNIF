...
![image 1-Nov-29-2023-08-28-39-0342-AM](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-1.webp)

3\. Select **App Registrations**.

![image 2-3](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-2.webp)
...
![image 3-2](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-3.webp)
...
![image 4-2](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-4.webp)
...
![image 5-2](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-5.webp)

7\. Copy the Client Secret value, you'll need it when configuring the Microsoft Graph Security API (Graph API) connector.

![image 6-2](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-6.webp)
...
![image 7-2](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-7.webp)
...
1. 1. In the Manage menu, select App roles.Click the **Create app role** tab.
    ...
    ![image 8-2](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-8.webp)

## **Configurations**

The following are the configurations to forward Microsoft Graph Security API (Graph API) Connector logs to DNIF.‌

![image 9-2](./images-MicrosoftGraphSecurityAPI/Microsoft-Graph-Security-API-9.webp)
