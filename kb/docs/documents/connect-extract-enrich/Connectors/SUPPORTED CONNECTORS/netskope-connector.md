...
![image 1-Apr-12-2024-04-41-52-9793-AM](./images-NetskopeConnector/Netskope-Connector-1.webp)
...
- Create the API token.  
    ...
    ![](./images-NetskopeConnector/Netskope-Connector-2.webp)
...
- Click **Save**. A confirmation box displays stating the token creation is successful.  
    ...
    ![](./images-NetskopeConnector/Netskope-Connector-3.webp)  
...
![image 4-Apr-12-2024-04-51-12-6522-AM](./images-NetskopeConnector/Netskope-Connector-4.webp)
