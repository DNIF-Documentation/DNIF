...
![image 1-Apr-12-2024-05-10-07-4825-AM](./images-JiraConnector/Jira-Connector-1.webp)

- Enter a memorable and concise Label for your token from the dialog that appears and click Create.

![image 2-Apr-12-2024-05-11-26-6072-AM](./images-JiraConnector/Jira-Connector-2.webp)

- Click copy button, then paste the token to your script, or elsewhere to save:  
      
    

![image 3-Apr-12-2024-05-12-58-6560-AM](./images-JiraConnector/Jira-Connector-3.webp)
...
![image 4-Apr-12-2024-05-16-04-4542-AM](./images-JiraConnector/Jira-Connector-4.webp)

- In the top header click on **More** then click on **Settings**.  
      
    

![image 5-Apr-12-2024-05-17-41-2689-AM](./images-JiraConnector/Jira-Connector-5.webp)

- In the **Details** tab find your Organization Name and copy the name.  
      
      
    ![image 6-Apr-12-2024-05-19-13-0321-AM](./images-JiraConnector/Jira-Connector-6.webp)
...
- The following are the configurations to forward Jira Connector logs to DNIF.‌  
    ...
    ![image 7-Apr-12-2024-05-20-44-3875-AM](./images-JiraConnector/Jira-Connector-7.webp)  
