...
![image 1-Apr-10-2024-12-04-35-9355-PM](./images-Auth0Connector/Auth0-Connector-1.webp)

- In the sidebar, click **Applications** under **Applications**  
    

![image 2-Apr-10-2024-12-06-23-1886-PM](./images-Auth0Connector/Auth0-Connector-2.webp)

- Click **Create Application**  
    


![image 3-Apr-10-2024-12-08-43-9288-PM](./images-Auth0Connector/Auth0-Connector-4.webp)

- Fill out the application form, enter the **Application Name**

![image 4-Apr-10-2024-12-10-45-1352-PM](./images-Auth0Connector/Auth0-Connector-5.webp)

- Choose the Application type as **Machine To Machine** and select **Auth0 Management API** as the API of the application.  
      
    ![image 5-Apr-10-2024-12-12-37-0763-PM](./images-Auth0Connector/Auth0-Connector-6.webp)  
...
![image 6-Apr-10-2024-12-14-19-8884-PM](./images-Auth0Connector/Auth0-Connector-7.webp)

- Select the **Settings** tab  
      
    ![image 7-Apr-10-2024-12-17-41-2170-PM](./images-Auth0Connector/Auth0-Connector-8.webp)

- Scroll down to see the credentials, copy the **Domain**, **Client ID**, **Client Secret** and store them securely.  
      
    ![image 8-Apr-10-2024-12-19-05-9395-PM](./images-Auth0Connector/Auth0-Connector-9.webp)
...
![image 9-Apr-10-2024-12-35-39-9341-PM](./images-Auth0Connector/Auth0-Connector-10.webp)
