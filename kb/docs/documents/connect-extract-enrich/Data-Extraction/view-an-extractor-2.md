...
- Hover on the **System** icon on the left navigation panel and select **Extraction**, the following page will be displayed.  
    ![](./images-ViewanExtractor/View-an-Extractor-1.png)
...
| ![](./images-ViewanExtractor/View-an-Extractor-2.png) | Allows you to delete the extractor, this will be displayed only for custom extractors |
| ![](./images-ViewanExtractor/View-an-Extractor-3.png) | Click this to refresh the extractor list |
| ![](./images-ViewanExtractor/View-an-Extractor-4.png) | Click this to search for a particular extractor |
| ![](./images-ViewanExtractor/View-an-Extractor-5.png) | Click this to add a new extractor |
