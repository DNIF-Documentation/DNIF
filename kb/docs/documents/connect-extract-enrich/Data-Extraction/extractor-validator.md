...
![](./images-Extractorvalidator/Extractor-validator-3.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-4.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-5.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-6.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-7.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-8.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-9.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-10.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-11.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-12.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-13.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-14.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-15.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-16.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-17.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-18.webp)  
      
    

## **Checking for duplicate streams and field**

This section focuses on issues related to streams and fields defined in the extractor, specifically concerning the **DNIF Data Model**.
<!-- (add an internal link here)(#DDM)  -->

Certain query-related problems may occur during parsing or due to case-sensitive errors in the fields. These errors are identified and highlighted as duplicate streams and duplicate fields. For example, a user may create a field "**User**" or "**USER**" for the "**AUTHENTICATION**" stream but the DNIF Data model already uses a field titled "**user**". Hence, such duplication should be avoided to ensure the data is parsed correctly.  

![](./images-Extractorvalidator/Extractor-validator-19.webp)

  
To address issues related to duplicate streams and fields in the DNIF extractor, refer to the **DNIF Data Model**

<!-- (add an internal link here)(#DDM)  -->section. This section provides a comprehensive view of the recommended streams and fields for troubleshooting purposes. By accessing the right-hand side modal, you can view a filtered list of streams and fields to help you identify and resolve case-sensitive errors in the data model.

![](./images-Extractorvalidator/Extractor-validator-20.webp)
...
![](./images-Extractorvalidator/Extractor-validator-23.webp)

  
Then search for the field shown as "SID” below.

![](./images-Extractorvalidator/Extractor-validator-24.webp)
...
![](./images-Extractorvalidator/Extractor-validator-25.webp)
...
1. Either refer to the  **DNIF Data Model Reference**

<!-- (add an internal link here)(#DDM)  -->
      
    ![](./images-Extractorvalidator/Extractor-validator-26.webp)  
...
3. Or, raise a support ticket, as demonstrated in the image above. Once the ticket is raised, the red cross will turn into a **yellow warning symbol** that will appear alongside a message stating, **"A ticket has been raised to DNIF support."** This will be followed by an email from the support team.  
    ...
    ![](./images-Extractorvalidator/Extractor-validator-27.webp)  
...
![](./images-Extractorvalidator/Extractor-validator-28.webp)
...
![](./images-Extractorvalidator/Extractor-validator-29.webp)
...
![](./images-Extractorvalidator/Extractor-validator-30.webp)
