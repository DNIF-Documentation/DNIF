...
1. DNIF AI-Assisted Extractor Generator

<!-- (add an internal link(#extractor-generator)):  -->
leverages generative artificial intelligence to automatically generate extractors from provided log samples. 

3. Manual Method

<!-- (add an internal link)(#manual-method):  -->

helps to manually create new extractors using the "Extraction" interface

5. [Cloning Method]

<!-- (add an internal link)(#cloning_method):  -->
...
3. Select "Manual" from the options provided, as illustrated in the image below.  
    ...
    ![](./images-CustomExtractors/Custom-Extractors-1.webp)
...
3. A new window will open as shown below, Enter a **Name** for the extractor you are about to create, and you can directly start writing in the yaml editor.  
    ...
    ![](./images-CustomExtractors/Custom-Extractors-2.png)  
...
5. Paste your **Log samples** in the below log samples section.  
    ...
    ![](./images-CustomExtractors/Custom-Extractors-3.png)  
      
    

7. Click **Submit** after writing the parser  
      
     ![](./images-CustomExtractors/Custom-Extractors-4.png)  
...
7. A popup window will appear next., it will allow you to  Disable the existing extractor, Click "**Save**" to finalize the creation of your custom extractor.  
    ...
    ![](./images-CustomExtractors/Custom-Extractors-8.png)  
...
![](./images-CustomExtractors/Custom-Extractors-9.webp)
...
![image 5-Dec-04-2023-11-46-42-9226-AM](./images-CustomExtractors/Custom-Extractors-10.webp)  
...
![image 6-Dec-04-2023-11-47-20-9193-AM](./images-CustomExtractors/Custom-Extractors-11.webp)  
...
![image 7-Dec-04-2023-11-47-59-2933-AM](./images-CustomExtractors/Custom-Extractors-12.webp)  
...
![image 8-Dec-04-2023-11-48-26-2332-AM](./images-CustomExtractors/Custom-Extractors-13.webp)  
...
![image 9-4](./images-CustomExtractors/Custom-Extractors-14.webp)  
...
![image 10-3](./images-CustomExtractors/Custom-Extractors-15.webp)  
...
![image 11-2](./images-CustomExtractors/Custom-Extractors-16.webp)  
...
1. **Fallback**:  
 ...
 ![image 12-4](./images-CustomExtractors/Custom-Extractors-17.webp)  
...
3. **Globals**                    Globals is a non-mandatory field. In this section we could define the generic fields that are present throughout the Extractor.  
    ...
    ![image 13-2](./images-CustomExtractors/Custom-Extractors-18.webp)  
...
5. **Substitutions**  
    ...
    ![image 14-2](./images-CustomExtractors/Custom-Extractors-19.webp)  
...
![image 15-2](./images-CustomExtractors/Custom-Extractors-20.webp)  
  

![image 16-2](./images-CustomExtractors/Custom-Extractors-21.webp)
