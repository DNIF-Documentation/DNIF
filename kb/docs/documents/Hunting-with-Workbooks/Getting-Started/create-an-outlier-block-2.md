...
![image 1-Dec-21-2023-05-12-27-6411-AM](./images-CreateanOutlierBlock/Create-an-Outlier-Block-1.png)

- Click **plus** icon on the Workbook page and select Outlier Block from the list, the following screen will be displayed.

### **Outlier Block**

![image 2-Dec-21-2023-05-12-44-5744-AM](./images-CreateanOutlierBlock/Create-an-Outlier-Block-2.png)
...
| ![image 3-Dec-21-2023-05-13-03-4211-AM](./images-CreateanOutlierBlock/Create-an-Outlier-Block-3.png) FILTER | Used to filter the features to be displayed in the grid and graph. |
| ![image 4-Dec-21-2023-05-13-13-9077-AM](./images-CreateanOutlierBlock/Create-an-Outlier-Block-4.png) Checkbox | Used to view only anomalies, this checkbox is selected by default, un-check this checkbox to view normal users along with anomalies |
...
![image 5-Dec-21-2023-05-13-34-5712-AM](./images-CreateanOutlierBlock/Create-an-Outlier-Block-5.png)
