...
![image 1-Dec-05-2023-07-27-03-4461-AM](./images-CreateaTextBlock/Create-a-Text-Block-1.png)

- Click the **plus** icon on the Workbook page and select **Text Block** from the list. The following screen is displayed:

![image 2-Dec-05-2023-07-27-23-6002-AM](./images-CreateaTextBlock/Create-a-Text-Block-2.png)

- Enter the required information in the Markdown Editor

![image 3-Dec-05-2023-07-27-39-6263-AM](./images-CreateaTextBlock/Create-a-Text-Block-3.png)

- Click anywhere outside the **Text Block**, to preview the Text Block as displayed below.

![image 4-Dec-05-2023-07-27-56-5915-AM](./images-CreateaTextBlock/Create-a-Text-Block-4.png)
