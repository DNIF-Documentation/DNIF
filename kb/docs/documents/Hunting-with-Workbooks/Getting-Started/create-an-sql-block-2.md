...
![image 1-Dec-21-2023-04-47-07-9790-AM](./images-CreateanSQLBlock/Create-a-SQL-Block-1.png)

- Click the **plus** icon on the Workbook page and select SQL Block from the list, the following screen will be displayed.

### **SQL Block**

![image 2-Dec-21-2023-04-47-20-6977-AM](./images-CreateanSQLBlock/Create-a-SQL-Block-2.png)

- Enter the query and click **Run** to execute the query, the result dataset will be displayed.

![image 3-Dec-21-2023-04-47-31-1170-AM](./images-CreateanSQLBlock/Create-a-SQL-Block-3.png)
...
![image 4-Dec-21-2023-04-47-44-3936-AM](./images-CreateanSQLBlock/Create-a-SQL-Block-4.webp)
...
| **Icons** | **Functionality** |
| --- | --- |
| ![image 5-Dec-21-2023-04-48-02-7426-AM](./images-CreateanSQLBlock/Create-a-SQL-Block-5.webp) | Used to filter the query result based on your requirement. |
| ![image 6-Dec-21-2023-04-48-09-9072-AM](./images-CreateanSQLBlock/Create-a-SQL-Block-6.webp) | User to delete the block |
| ![image 7-Dec-21-2023-04-48-16-3726-AM](./images-CreateanSQLBlock/Create-a-SQL-Block-7.webp) | Used to export logs in CSV format |
