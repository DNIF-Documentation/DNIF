...
![image 1-Dec-04-2023-07-01-40-9544-AM](./images-CreateaSearchBlock/Create-a-Search-Block-1.webp)
...
![image 2-Dec-04-2023-07-02-08-9806-AM](./images-CreateaSearchBlock/Create-a-Search-Block-2.webp)
...
| **Aggregate**   ![image 3-Dec-04-2023-07-02-41-0915-AM](./images-CreateaSearchBlock/Create-a-Search-Block-3.webp)   | Below are the Aggregate Functions |
...
| Filter    ![image 4-Dec-04-2023-07-04-20-7232-AM](./images-CreateaSearchBlock/Create-a-Search-Block-4.webp)   | Used to add filters to the query based on your requirement. |
| ![image 5-Dec-04-2023-07-04-54-2189-AM](./images-CreateaSearchBlock/Create-a-Search-Block-5.webp)/ ![image 6-Dec-04-2023-07-05-03-9873-AM](./images-CreateaSearchBlock/Create-a-Search-Block-6.webp)  | Used to hide or unhide the query results |
...
| ![image 7-Dec-04-2023-07-05-21-5225-AM](./images-CreateaSearchBlock/Create-a-Search-Block-7.webp)  | Used to search raw payload, with logevent in query or payload flag.   **Note:** Default searches do not include raw payload unless logevent is referred in query or with payload flag.   **For example,**   \_fetch $CNAMTime, $LogEvent from event limit 10   \_fetch \* from event where $LogEvent=DESKTOP limit 10   \_fetch \* from event where $Stream=FIREWALL limit 10 with payload |
| ![image 8-4](./images-CreateaSearchBlock/Create-a-Search-Block-8.webp) | Used to filter the query result based on your requirement. |
| ![image 9-3](./images-CreateaSearchBlock/Create-a-Search-Block-9.webp) | Used to export logs in CSV format |
...
![image 10-2](./images-CreateaSearchBlock/Create-a-Search-Block-10.webp)

- Once the query is successfully processed, the results will be displayed as below.

![image 11-1](./images-CreateaSearchBlock/Create-a-Search-Block-11.webp)

- Click **Information** icon, to view log details. You can view the log details in JSON and TABLE format.

![image 12-3](./images-CreateaSearchBlock/Create-a-Search-Block-12.webp)
...
- You can view the signals with field values ending in a specific pattern by adding the character ‘\*’  at the beginning of the search string.  
    ...
    **$Action = \*\_BLOCKED**  
    ...
    ![Prepend_asterisk](./images-CreateaSearchBlock/Create-a-Search-Block-15.webp)  
...
![](./images-CreateaSearchBlock/Create-a-Search-Block-16.webp)
